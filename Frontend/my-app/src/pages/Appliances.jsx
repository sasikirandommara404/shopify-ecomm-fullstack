...
export const Appliances = () => {
  ...
  useEffect(() => {
    const fetchProducts = async () => {
      try {
        const response = await axios.get('http://localhost:5000/api/getallproducts/Appliances');
            ...
            <div className="col-12 col-lg-10">
              ...
              <h1 
                ...
                style={{
                  ...
                  fontWeight: '900',
                  textShadow: '3px 6px 12px rgba(0,0,0,0.3)',
                  letterSpacing: '-2px',
                  lineHeight: '1.2'
                }}
              >
              ...
              >
                Smart Solutions for Modern Living - First Order Discount
              </p>
